...
const Links = () => {
    ...
    <div >
        <ul className="flex text-white">
            ...
            <li className='px-3'><Link to={"/cart"}>Cart {cartValue.length}</Link></li>
        </ul>
    </div>
)}
const LoginLogout = ()=>{
