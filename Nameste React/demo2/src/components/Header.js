...
const Header = () => (
    <div className='flex bg-slate-800 p-3 justify-between items-center sticky top-0 left-0 right-0'>
        {logo()}
        {Links()}
        <Status />
        {LoginLogout()}
